...
dlurl=https://dbcg.github.io/latest-cqf-tooling/tooling-1.0-SNAPSHOT-jar-with-dependencies.jar
...
#	wget "https://dbcg.github.io/latest-cqf-tooling/tooling-1.0-SNAPSHOT-jar-with-dependencies.jar" -O "$jarlocation"
